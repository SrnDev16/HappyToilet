  ...
  return (
    <>
      <div className="md:max-w-3xl mx-auto  p-2">
        ...
        <div className="table table-fixed w-full border">
          <div className="table-header-group">
            <div className="table-row">
              <div className="table-cell text-center  text-xl p-1">
                โรงเรียน
              </div>
              <div className="table-cell text-center border-l text-xl p-1">Link</div>
            </div>
          </div>
          <div className="table-row-group">
            {SchoolLink.map((data, index) => (
              <div className="table-row" key={index}>
                ...
                <div
                  className={`table-cell border-l p-1 ${
                    index % 2 === 0 ? "bg-slate-200" : "bg-white"
                  }`}
                >
